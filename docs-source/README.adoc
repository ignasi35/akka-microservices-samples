(copy/pasted from https://github.com/lightbend/cloudflow/blob/master/docs/docs-source/README.adoc)
...
Any code snippets, being *Scala* or *Java* must not be hard-coded inside the documentation source.
...
Note that `_reference_this_heading` is generated automatically from a title like `== Reference This Heading`. Prefer adding stable anchors:

----
== Reference This Heading
[#stable_anchor_to_ref_this_heading]
----

And use them like:

----
xref:mypage.adoc#stable_anchor_to_ref_this_heading[Reference this heading]
----
...
see https://github.com/lightbend/cloudflow/blob/master/docs/docs-source/README.adoc
