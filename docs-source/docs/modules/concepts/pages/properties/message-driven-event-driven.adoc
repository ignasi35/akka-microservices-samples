...
There are multiple types of messages. A categorization of messages in a xref:techniques/cqrs.adoc[CQRS]/xref:techniques/event-sourcing[ES] application is the following:
